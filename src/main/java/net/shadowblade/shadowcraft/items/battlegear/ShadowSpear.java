...
public class ShadowSpear extends ItemSword implements IExtendedReachWeapon, IRepairable
{
    public ShadowSpear()
    {
        super(SCItems.ShadowToolMaterial);
        this.setUnlocalizedName(Refs.SHADOW_SPEAR);
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
        ...
        par3List.add(EnumChatFormatting.DARK_GREEN + "Reach: +2");
    }
}
